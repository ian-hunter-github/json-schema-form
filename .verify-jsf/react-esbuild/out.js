...
// node_modules/@ianhunterpersonal/jsf-react/dist/index.js
var import_react = __toESM(require_react(), 1);

// node_modules/@ianhunterpersonal/jsf-core/dist/index.js
var import_fast_deep_equal = __toESM(require_fast_deep_equal(), 1);
var import_ajv = __toESM(require_ajv(), 1);
var import_ajv_formats = __toESM(require_dist(), 1);
var splitPath = (p) => p === "" ? [] : p.split(".").map((seg) => seg.match(/^\d+$/) ? Number(seg) : seg);
...
var applyDefaults = (schema, data) => {
  if (schema == null) return data;
  if (data == null && schema.default !== void 0) return structuredClone(schema.default);
  ...
  if (isObject(data)) {
    ...
    for (const key of Object.keys(props)) {
      result[key] = applyDefaults(props[key], result[key]);
    }
    return result;
  }
  return data;
...
function makeAjv(schema) {
  const key = String(schema?.$id || "no-id");
  if (ajvCache.has(key)) return ajvCache.get(key);
  const ajv = new import_ajv.default({
    strict: false,
    // <-- allow unknown keywords like x-*
    allErrors: true,
...
function createEngine(schema, initialData = {}, opts = {}) {
  let _schema = schema;
  ...
  function setActiveBranch(containerPath, index) {
...
function applyConstTagsForBranch(engine, path, branchSchema, enable) {
  if (!enable) return;
...
function getSchemaAtPath(root, path) {
  if (!path) return root;
...
var JsonSchemaForm = ({
  ...
  const engineRef = (0, import_react.useRef)(
    createEngine(schema, initialData, { keepDataOnOneOfSwitch })
  );
  const [tick, setTick] = (0, import_react.useState)(0);
  const schedule = useDebounced(debounceMs);
  const prefix = (c) => classNamePrefix + c;
  const constPathsRef = (0, import_react.useRef)(/* @__PURE__ */ new Set());
  const hiddenConstPathsRef = (0, import_react.useRef)(/* @__PURE__ */ new Set());
  const resetConstPaths = () => {
    constPathsRef.current = /* @__PURE__ */ new Set();
  };
  (0, import_react.useEffect)(() => {
  ...
  (0, import_react.useEffect)(() => {
    if (firstMount.current && initialData !== void 0) {
  ...
  const runPostChange = () => {
    schedule(async () => {
      const ok = engineRef.current.validate();
      const st = engineRef.current.getState();
      let errs = st.errors;
      if (transformError)
        errs = errs.map(transformError).filter(Boolean);
  ...
  const applyChange = async (path, value) => {
  ...
  const errors = (0, import_react.useMemo)(() => {
    ...
    if (transformError) {
      errs = errs.map(transformError).filter((x) => Boolean(x));
    }
    const active = state.activeOneOf || {};
    errs = errs.filter(
      (e) => !(e.keyword === "oneOf" && Object.prototype.hasOwnProperty.call(active, e.path))
    );
    if (constErrorStrategy === "suppress-when-managed") {
      errs = errs.filter(
        (e) => !(e.keyword === "const" && constPathsRef.current.has(e.path))
  ...
  const fieldError = (path) => errors.find((e) => e.path === path);
  const renderField = ({
    schema: s,
    path,
    required
      ...
      if (constVisibility === "readonly") {
        return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { className: prefix("label"), htmlFor: id, children: [
                title,
                required ? " *" : ""
              ] }),
              ...
              err && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: prefix("error"), id: id + "-err", children: err.message })
            ]
          }
        );
      }
    ...
    if (Array.isArray(s?.oneOf) || Array.isArray(s?.anyOf)) {
      ...
      const discProp = typeof s?.discriminator?.propertyName === "string" ? s.discriminator.propertyName : null;
      if (discProp) {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              "select",
              {
                ...
                children: group.map((g, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: String(i), children: g.title ?? `${title} (${i + 1})` }, i))
              }
            ),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: prefix("object"), children: renderField({ schema: group[idx], path, required }) }),
            err && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: prefix("error"), id: id + "-err", children: err.message })
          ]
        }
      );
    ...
    if (Array.isArray(s?.enum)) {
      const value2 = getByPath(state.data, path);
      const strValue = typeof value2 === "string" ? value2 : value2 == null ? "" : JSON.stringify(value2);
      const labels = (s["x-enumNames"] || s["x-enum-labels"] || s.enum).map((x) => String(x));
      return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
        "div",
        {
          className: wrapCls,
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
              "select",
              {
                ...
                onChange: (e) => {
                  ...
                  if (s.enum.some((x) => typeof x !== "string")) {
                    try {
                      v = JSON.parse(v);
                    } catch {
                    }
                ...
                children: [
                  ...
                  s.enum.map((v, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                    "option",
                    {
    ...
    if (t === "object" || s.properties) {
      ...
      const extraKeys = additionalSchema ? Object.keys(objVal).filter((k) => !(s.properties || {})[k]) : [];
      return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
        "fieldset",
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("legend", { className: prefix("label"), children: [
              title,
              required ? " *" : ""
            ] }),
            Object.entries(s.properties || {}).map(([k, sub]) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_react.default.Fragment, { children: renderField({
              schema: sub,
              path: path ? `${path}.${k}` : k,
              required: req2.includes(k)
            }) }, k)),
            additionalSchema && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { marginTop: 6 }, children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "Additional properties" }),
              extraKeys.map((k) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                "div",
                {
                  style: {
                    display: "grid",
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
              items.map((_v, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { marginBottom: 8 }, children: [
                renderField({
                  schema: s.items,
                  path: `${path}.${i}`,
                  required: false
                }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", onClick: () => removeItem(path, i), children: "Remove" })
              ] }, i)),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", onClick: () => addItem(path), children: "Add" })
            ] }),
            err && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: prefix("error"), id: id + "-err", children: err.message })
          ]
        }
    ...
    const commonProps = {
      id,
      className: prefix("input"),
      "aria-invalid": !!err || void 0,
      "aria-describedby": err ? id + "-err" : void 0
    };
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "div",
      {
  ...
  const renderAddKeyRow = (path) => {
    const [key, setKey] = (0, import_react.useState)("");
    const AddKeyRow = () => {
      const [k, setK] = (0, import_react.useState)("");
      return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", gap: 8, marginTop: 8 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "input",
          {
            className: prefix("input"),
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AddKeyRow, {});
  };
  resetConstPaths();
  hiddenConstPathsRef.current = /* @__PURE__ */ new Set();
  const req = schema.required || [];
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", { className: prefix("form"), noValidate: true, onSubmit: handleSubmit, children: [
    schema.type === "object" || schema.properties ? Object.entries(schema.properties || {}).map(([k, s]) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_react.default.Fragment, { children: renderField({
      schema: s,
      path: k,
      required: req.includes(k)
    }) }, k)) : renderField({ schema, path: "", required: false }),
    ...
    debug && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      "pre",
      {
        style: {
          background: "#fafafa",
